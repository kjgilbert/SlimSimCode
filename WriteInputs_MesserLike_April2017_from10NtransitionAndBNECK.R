...
make.slim.input <- function(filename.start, input.file, rand.seed="1234567890", pop.size=10000, ben.muts=FALSE, delet.effect, ben.effect, mut.props, mate.sys, prop.mate.type="", scenario.name, total.N.gens=10, samp.size=100, samp.type, sampling.points, rep, dontSampleFull=FALSE, dominance=0.3, bottleneck.size, bottleneck.duration){
...
# the following all happens within the loop, controlled by the if statements
# SAMPLE DURING THE BOTTLENECK
# END THE BOTTLENECK
...
# COMPLETE REMAINING SAMPLES TO END
	...
	for(j in reps){
		...
		if(is.null(s.b)){
			...
			make.slim.input(filename.start=paste(c("Apr21_25N_", mut.names), collapse=""), input.file=paste(c(their.directory, filename), collapse=""),
				...
				scenario.name="TransBottleneck-",
				total.N.gens=N.number.generations, samp.size=inds.to.sample, samp.type=sample.dips, rep=reps[iterate], 
				dominance=dom.val, delet.effect=s.d, sampling.points=samp.pts, bottleneck.size=bneck.size, bottleneck.duration=bneck.duration)	
		
			# selfers
			make.slim.input(filename.start=paste(c("Apr21_25N_", mut.names), collapse=""), input.file=paste(c(their.directory, filename), collapse=""),
				rand.seed=rand.sd, pop.size=pop.size, ben.muts=FALSE, scenario.name="TransBottleneck-",
				total.N.gens=N.number.generations, samp.size=inds.to.sample, samp.type=sample.dips, rep=reps[iterate], 
				mate.sys="self", prop.mate.type="0.90", dominance=dom.val, delet.effect=s.d, sampling.points=samp.pts, bottleneck.size=bneck.size, bottleneck.duration=bneck.duration)	
			make.slim.input(filename.start=paste(c("Apr21_25N_", mut.names), collapse=""), input.file=paste(c(their.directory, filename), collapse=""),
				rand.seed=rand.sd, pop.size=pop.size, ben.muts=FALSE, scenario.name="TransBottleneck-",
				total.N.gens=N.number.generations, samp.size=inds.to.sample, samp.type=sample.dips, rep=reps[iterate], 
				mate.sys="self", prop.mate.type="0.99", dominance=dom.val, delet.effect=s.d, sampling.points=samp.pts, bottleneck.size=bneck.size, bottleneck.duration=bneck.duration)	
			#asex
			make.slim.input(filename.start=paste(c("Apr21_25N_", mut.names), collapse=""), input.file=paste(c(their.directory, filename), collapse=""),
				rand.seed=rand.sd, pop.size=pop.size, ben.muts=FALSE, scenario.name="TransBottleneck-",
				total.N.gens=N.number.generations, samp.size=inds.to.sample, samp.type=sample.dips, rep=reps[iterate], 
				mate.sys="asex", prop.mate.type="0.90", dominance=dom.val, delet.effect=s.d, sampling.points=samp.pts, bottleneck.size=bneck.size, bottleneck.duration=bneck.duration)	
			make.slim.input(filename.start=paste(c("Apr21_25N_", mut.names), collapse=""), input.file=paste(c(their.directory, filename), collapse=""),
				rand.seed=rand.sd, pop.size=pop.size, ben.muts=FALSE, scenario.name="TransBottleneck-",
				total.N.gens=N.number.generations, samp.size=inds.to.sample, samp.type=sample.dips, rep=reps[iterate], 
				mate.sys="asex", prop.mate.type="0.99", dominance=dom.val, delet.effect=s.d, sampling.points=samp.pts, bottleneck.size=bneck.size, bottleneck.duration=bneck.duration)	
		}else{
			#outcrossers
			make.slim.input(filename.start=paste(c("Apr21_25N_", mut.names), collapse=""), input.file=paste(c(their.directory, filename), collapse=""),
				...
				scenario.name="TransBottleneck-",
				total.N.gens=N.number.generations, samp.size=inds.to.sample, samp.type=sample.dips, rep=reps[iterate], 
				dominance=dom.val, delet.effect=s.d, ben.effect=s.b, mut.props=mut.prop, sampling.points=samp.pts, bottleneck.size=bneck.size, bottleneck.duration=bneck.duration)
			#selfers
			make.slim.input(filename.start=paste(c("Apr21_25N_", mut.names), collapse=""), input.file=paste(c(their.directory, filename), collapse=""),
				rand.seed=rand.sd, pop.size=pop.size, ben.muts=TRUE, scenario.name="TransBottleneck-",
				total.N.gens=N.number.generations, samp.size=inds.to.sample, samp.type=sample.dips, rep=reps[iterate], 
				mate.sys="self", prop.mate.type="0.90", dominance=dom.val, delet.effect=s.d, ben.effect=s.b, mut.props=mut.prop, sampling.points=samp.pts, bottleneck.size=bneck.size, bottleneck.duration=bneck.duration)
			make.slim.input(filename.start=paste(c("Apr21_25N_", mut.names), collapse=""), input.file=paste(c(their.directory, filename), collapse=""),
				rand.seed=rand.sd, pop.size=pop.size, ben.muts=TRUE, scenario.name="TransBottleneck-",
				total.N.gens=N.number.generations, samp.size=inds.to.sample, samp.type=sample.dips, rep=reps[iterate], 
				mate.sys="self", prop.mate.type="0.99", dominance=dom.val, delet.effect=s.d, ben.effect=s.b, mut.props=mut.prop, sampling.points=samp.pts, bottleneck.size=bneck.size, bottleneck.duration=bneck.duration)
			#asex
			make.slim.input(filename.start=paste(c("Apr21_25N_", mut.names), collapse=""), input.file=paste(c(their.directory, filename), collapse=""),
				rand.seed=rand.sd, pop.size=pop.size, ben.muts=TRUE, scenario.name="TransBottleneck-",
				total.N.gens=N.number.generations, samp.size=inds.to.sample, samp.type=sample.dips, rep=reps[iterate], 
				mate.sys="asex", prop.mate.type="0.90", dominance=dom.val, delet.effect=s.d, ben.effect=s.b, mut.props=mut.prop, sampling.points=samp.pts, bottleneck.size=bneck.size, bottleneck.duration=bneck.duration)
			make.slim.input(filename.start=paste(c("Apr21_25N_", mut.names), collapse=""), input.file=paste(c(their.directory, filename), collapse=""),
				rand.seed=rand.sd, pop.size=pop.size, ben.muts=TRUE, scenario.name="TransBottleneck-",
				total.N.gens=N.number.generations, samp.size=inds.to.sample, samp.type=sample.dips, rep=reps[iterate], 
				mate.sys="asex", prop.mate.type="0.99", dominance=dom.val, delet.effect=s.d, ben.effect=s.b, mut.props=mut.prop, sampling.points=samp.pts, bottleneck.size=bneck.size, bottleneck.duration=bneck.duration)
