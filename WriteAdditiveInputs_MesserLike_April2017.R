...
dir <- "~/Documents/My_Documents/UofToronto/SLiM/Running_SLiM/April2017_NewMesserLikeSims/CompareAdditivity/Inputs"
...
for(i in rand.seeds){
	# outcrossing:
	make.slim.input(filename.start="Apr18_50N_hp5d01", rand.seed=i, pop.size=pop.size, ben.muts=FALSE, mate.sys="outc", 
	...
	make.slim.input(filename.start="Apr18_50N_hp5d0005", rand.seed=i, pop.size=pop.size, ben.muts=FALSE, mate.sys="outc", 
		total.N.gens=N.number.generations, samp.size=inds.to.sample, samp.type=sample.dips, rep=reps[iterate], 
		dominance=dom.val, delet.effect="-0.001")	
	
	# AND WITH BENEFICIALS:
	# outcrossing:
	make.slim.input(filename.start="Apr18_50N_hp5b01d01", rand.seed=i, pop.size=pop.size, ben.muts=TRUE, mate.sys="outc", 
		total.N.gens=N.number.generations, samp.size=inds.to.sample, samp.type=sample.dips, rep=reps[iterate], 
		dominance=dom.val, delet.effect="-0.01", ben.effect="0.01", mut.props="0.749937, 0.000063")
	make.slim.input(filename.start="Apr18_50N_hp5b01d0005", rand.seed=i, pop.size=pop.size, ben.muts=TRUE, mate.sys="outc", 
		total.N.gens=N.number.generations, samp.size=inds.to.sample, samp.type=sample.dips, rep=reps[iterate], 
		dominance=dom.val, delet.effect="-0.0005", ben.effect="0.01", mut.props="0.749937, 0.000063")
	make.slim.input(filename.start="Apr18_50N_hp5b001d01", rand.seed=i, pop.size=pop.size, ben.muts=TRUE, mate.sys="outc", 
		total.N.gens=N.number.generations, samp.size=inds.to.sample, samp.type=sample.dips, rep=reps[iterate], 
		dominance=dom.val, delet.effect="-0.01", ben.effect="0.001", mut.props="0.749375, 0.000625")
	make.slim.input(filename.start="Apr18_50N_hp5b001d0005", rand.seed=i, pop.size=pop.size, ben.muts=TRUE, mate.sys="outc", 
		total.N.gens=N.number.generations, samp.size=inds.to.sample, samp.type=sample.dips, rep=reps[iterate], 
...
for(i in rand.seeds){
	# outcrossing:
	make.slim.input(filename.start="Apr18_50N_hp3d01", rand.seed=i, pop.size=pop.size, ben.muts=FALSE, mate.sys="outc", 
		total.N.gens=N.number.generations, samp.size=inds.to.sample, samp.type=sample.dips, rep=reps[iterate], 
		dominance=dom.val, delet.effect="-0.01")	
	make.slim.input(filename.start="Apr18_50N_hp3d0005", rand.seed=i, pop.size=pop.size, ben.muts=FALSE, mate.sys="outc", 
		total.N.gens=N.number.generations, samp.size=inds.to.sample, samp.type=sample.dips, rep=reps[iterate], 
		dominance=dom.val, delet.effect="-0.001")	
	
	# AND WITH BENEFICIALS:
	# outcrossing:
	make.slim.input(filename.start="Apr18_50N_hp3b01d01", rand.seed=i, pop.size=pop.size, ben.muts=TRUE, mate.sys="outc", 
		total.N.gens=N.number.generations, samp.size=inds.to.sample, samp.type=sample.dips, rep=reps[iterate], 
		dominance=dom.val, delet.effect="-0.01", ben.effect="0.01", mut.props="0.749937, 0.000063")
	make.slim.input(filename.start="Apr18_50N_hp3b01d0005", rand.seed=i, pop.size=pop.size, ben.muts=TRUE, mate.sys="outc", 
		total.N.gens=N.number.generations, samp.size=inds.to.sample, samp.type=sample.dips, rep=reps[iterate], 
		dominance=dom.val, delet.effect="-0.0005", ben.effect="0.01", mut.props="0.749937, 0.000063")
	make.slim.input(filename.start="Apr18_50N_hp3b001d01", rand.seed=i, pop.size=pop.size, ben.muts=TRUE, mate.sys="outc", 
		total.N.gens=N.number.generations, samp.size=inds.to.sample, samp.type=sample.dips, rep=reps[iterate], 
		dominance=dom.val, delet.effect="-0.01", ben.effect="0.001", mut.props="0.749375, 0.000625")
	make.slim.input(filename.start="Apr18_50N_hp3b001d0005", rand.seed=i, pop.size=pop.size, ben.muts=TRUE, mate.sys="outc", 
		total.N.gens=N.number.generations, samp.size=inds.to.sample, samp.type=sample.dips, rep=reps[iterate], 
		dominance=dom.val, delet.effect="-0.0005", ben.effect="0.001", mut.props="0.749375, 0.000625")
...
for(i in rand.seeds){
	# outcrossing:
	make.slim.input(filename.start="Apr18_50N_hp1d01", rand.seed=i, pop.size=pop.size, ben.muts=FALSE, mate.sys="outc", 
		total.N.gens=N.number.generations, samp.size=inds.to.sample, samp.type=sample.dips, rep=reps[iterate], 
		dominance=dom.val, delet.effect="-0.01")	
	make.slim.input(filename.start="Apr18_50N_hp1d0005", rand.seed=i, pop.size=pop.size, ben.muts=FALSE, mate.sys="outc", 
		total.N.gens=N.number.generations, samp.size=inds.to.sample, samp.type=sample.dips, rep=reps[iterate], 
		dominance=dom.val, delet.effect="-0.001")	
	
	# AND WITH BENEFICIALS:
	# outcrossing:
	make.slim.input(filename.start="Apr18_50N_hp1b01d01", rand.seed=i, pop.size=pop.size, ben.muts=TRUE, mate.sys="outc", 
		total.N.gens=N.number.generations, samp.size=inds.to.sample, samp.type=sample.dips, rep=reps[iterate], 
		dominance=dom.val, delet.effect="-0.01", ben.effect="0.01", mut.props="0.749937, 0.000063")
	make.slim.input(filename.start="Apr18_50N_hp1b01d0005", rand.seed=i, pop.size=pop.size, ben.muts=TRUE, mate.sys="outc", 
		total.N.gens=N.number.generations, samp.size=inds.to.sample, samp.type=sample.dips, rep=reps[iterate], 
		dominance=dom.val, delet.effect="-0.0005", ben.effect="0.01", mut.props="0.749937, 0.000063")
	make.slim.input(filename.start="Apr18_50N_hp1b001d01", rand.seed=i, pop.size=pop.size, ben.muts=TRUE, mate.sys="outc", 
		total.N.gens=N.number.generations, samp.size=inds.to.sample, samp.type=sample.dips, rep=reps[iterate], 
		dominance=dom.val, delet.effect="-0.01", ben.effect="0.001", mut.props="0.749375, 0.000625")
	make.slim.input(filename.start="Apr18_50N_hp1b001d0005", rand.seed=i, pop.size=pop.size, ben.muts=TRUE, mate.sys="outc", 
		total.N.gens=N.number.generations, samp.size=inds.to.sample, samp.type=sample.dips, rep=reps[iterate], 
		dominance=dom.val, delet.effect="-0.0005", ben.effect="0.001", mut.props="0.749375, 0.000625")
