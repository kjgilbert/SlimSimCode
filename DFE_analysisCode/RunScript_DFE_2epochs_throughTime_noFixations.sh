...
Rscript CommandLine_RunSlimToDFEconversion_transMateSys_NoFixations.R $base_name subsample $dir $genosize
# create divergence file (for all of them because easier to do in this loop anyway
Rscript CommandLine_RunSlimToAlphaOmega_transMateSys_NoFixations.R $base_name subsample $dir $genosize
done
