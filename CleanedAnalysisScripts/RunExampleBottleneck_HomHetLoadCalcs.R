...
effect.size.min <- c(-0.00001, -0.0001, -0.001, -0.01, -0.1, -1, -1, -1, -0.1, -0.01, -0.001, -0.0001)                # the MOST negative in the range wanted
effect.size.max <- c(0, 0, 0, 0, 0, 0, -0.1, -0.01, -0.01, -0.001, -0.0001, -0.00001)
