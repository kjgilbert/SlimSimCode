...
dir <- "/cap1/kgilbert/RunningR_SlimResults/Jan4_N1000_SlimOutputsFiles"
setwd(paste(c(dir, "/Jan3_bneck1000gens"), collapse=""))

sample.files <- system("ls SampleOutput_Jan3-1e3bneck_N10000_25mbp_*", intern=TRUE)
fixed.files <- system("ls FixedOutput_Jan3-1e3bneck_N10000_25mbp_*", intern=TRUE)
...
output.file <- "RelativeLoad_Jan3_bottleneck1000gens.csv"
