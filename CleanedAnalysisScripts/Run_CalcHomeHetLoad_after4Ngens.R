...
sample.files <- system("ls Nov19_25Mbp_Outputs/SampleOutput_Nov19_N10000_25mbp_*", intern=TRUE)
fixed.files <- system("ls Nov19_25Mbp_Outputs/FixedOutput_Nov19_N10000_25mbp_*", intern=TRUE)
full.files <- system("ls Nov19_25Mbp_Outputs/FullOutput_Nov19_N10000_25mbp_*", intern=TRUE)
...
gens.to.sample.at <- format(seq(pop.size*1, pop.size*10, by=pop.size), scientific=FALSE)
