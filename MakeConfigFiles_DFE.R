...
# args[4]: numeric -- mean beta		from DFE example, = 0.5
...
"), collapse="")
class0.output <- paste(c("est_dfe_results_dir OutputClass0_", unlist(strsplit(as.character(args[3]), split="\\."))[1]), collapse="")
...
class1.output <- paste(c("est_dfe_results_dir OutputClass1_", unlist(strsplit(as.character(args[3]), split="\\."))[1]), collapse="")
class0output.class1input <- paste(c("est_dfe_demography_results_file OutputClass0_", unlist(strsplit(as.character(args[3]), split="\\."))[1], " est_dfe.out"), collapse="")
...
"), collapse="")
	new.results.line <- paste(c("est_alpha_omega_results_file est_alpha_omega", unlist(strsplit(as.character(args[3]), split="\\."))[1], ".out
	"), collapse="")
	prev.dfe.results <- paste(c("est_dfe_results_file OutputClass1_", unlist(strsplit(as.character(args[3]), split="\\."))[1], "/est_dfe.out
"), collapse="")
	prev.neut.results <- paste(c("neut_egf_file OutputClass0_", unlist(strsplit(as.character(args[3]), split="\\."))[1], "/neut_egf.out
"), collapse="")
	prev.sel.results <- paste(c("sel_egf_file OutputClass1_", unlist(strsplit(as.character(args[3]), split="\\."))[1], "/sel_egf.out
"), collapse="")
