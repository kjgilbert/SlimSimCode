...
plots.summ.stats <- function(output.filename, dat, bendat, xlimits, jitter=25, genome.size){
	...
	pdf(output.filename, width=10, height=9)
	...
	# dN/dS total
	plot(0, type="n", xlim=xlimits, ylim=c(0, 1.2), xlab="Generation", ylab="dN / dS", main="dN / dS")
	...
	# ALPHA
	plot(0, type="n", xlim=xlimits, ylim=c(0, 1), xlab="Generation", ylab="alpha", main="proportion adaptive substitutions")
	...
	plot(0, type="n", xlim=xlimits, ylim=c(0, 1.2), xlab="Generation", ylab="dN / dS", main="dN/dS - Deleterious only")
	...
	plot(0, type="n", xlim=xlimits, ylim=c(0, 1.2), xlab="Generation", ylab="dN / dS", main="dN / dS - Beneficial only")
